export function SkeletonCard(): JSX.Element {
  return (
    <div className="animate-pulse rounded-xl border border-orange-100 bg-white p-4">
      <div className="mb-3 h-44 w-full rounded-lg bg-orange-100" />
      <div className="space-y-2">
        ...
        <div className="h-9 w-full rounded-lg bg-orange-100" />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="animate-pulse space-y-2">
      <div className="flex gap-4 rounded-lg bg-orange-50 p-3">
        <div className="h-4 flex-1 rounded bg-orange-200" />
        <div className="h-4 w-24 rounded bg-orange-200" />
        <div className="h-4 w-24 rounded bg-orange-200" />
      </div>
      {Array.from({ length: rows }).map((_, i) => (
        <div key={i} className="flex gap-4 rounded-lg bg-white p-3">
          <div className="h-3 flex-1 rounded bg-orange-100" />
  ...
  return (
    <div className="animate-pulse space-y-2">
      {Array.from({ length: lines }).map((_, i) => (
        <div key={i} className={`h-4 rounded bg-orange-100 ${i === lines - 1 ? "w-3/4" : "w-full"}`} />
      ))}
    </div>
  );
}
...
export function SkeletonPage(): JSX.Element {
  return (
    <div className="space-y-5 animate-pulse">
      ...
      <div className="h-4 w-72 rounded bg-orange-100" />
