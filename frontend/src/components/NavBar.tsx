...
export function NavBar(): JSX.Element {
  ...
  return (
    <header className="border-b border-orange-100 bg-white/90 shadow-sm backdrop-blur transition-shadow duration-200">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg border border-orange-200 bg-orange-50 px-3 py-2 text-sm font-medium text-orange-900 transition-all duration-150 hover:bg-orange-100 active:scale-95"
            >
              <MenuIcon />
              Menú
            </button>
            <span className="font-display text-lg font-bold tracking-tight text-orange-700">Food Store</span>
            {user && (
        ...
        <div className={`grid transition-all duration-200 ${open ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"}`}>
          <div className="overflow-hidden">
            ...
            <NavLink
              to="/home"
              className={({ isActive }) =>
                `flex items-center gap-1.5 rounded-lg px-3 py-2 text-sm font-medium transition-all duration-150 ${isActive ? "bg-orange-500 text-white shadow-sm" : "bg-orange-100 text-orange-900 hover:bg-orange-200"}`
              }
            >
              <HomeIcon />
              Home
